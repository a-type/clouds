...
function polygonize(
  ...
  if (bits & 16) {
    computeNormal(qz);
    computeNormal(q1z);
    vertexInterpolateX(qz * 3, 12, isol, fx, fy, fz2, field4, field5, qz, q1z);
  }
  ...
  if (bits & 128) {
    computeNormal(qz);
    computeNormal(qyz);
    vertexInterpolateY(qz * 3, 21, isol, fx, fy, fz2, field4, field6, qz, qyz);
  }
  ...
  if (bits & 512) {
    computeNormal(q1);
    computeNormal(q1z);
    vertexInterpolateZ(q1 * 3, 27, isol, fx2, fy, fz, field1, field5, q1, q1z);
  }
  if (bits & 1024) {
    computeNormal(q1y);
    computeNormal(q1yz);
  ...
  if (bits & 2048) {
    computeNormal(qy);
    computeNormal(qyz);
    vertexInterpolateZ(qy * 3, 33, isol, fx, fy2, fz, field2, field6, qy, qyz);
  }
